        ...
        <div class="w3-black w3-opacity-min w3-center w3-card w3-margin-left w3-margin-right wide w3-round">
                      ...
                      <form name="frmregister" method="POST" class="wide w3-content" >
                          ...
                          <h2><b><b><u>Personal Details</u></b></b></h2>
                                    NAME:<input type="text" name="txtname" id="txtname" class="w3-padding-16 w3-round w3-input w3-border w3-content "
                                    ...
                                    PASSPORT SIZE PHOTO:<input type="file" style="border:none;border-bottom:2px solid orange;background-color:inherit;color:white;" name="txnmobile" placeholder="Upload your BHAMASHAH CARD XEROX" required="" class="w3-padding-16 w3-input w3-border w3-content w3-round"/>
                                                                          <br/>
                                    PHONE NO.:<input type="number" style="border:none;border-bottom:2px solid orange;background-color:inherit;color:white;" name="txnmobile" placeholder="Enter phone number" class="w3-padding-16 w3-input w3-border w3-content w3-round" required=""><br/>
                                    
                                    Date of Birth:<input type="Date" name="dtdob" class="w3-padding-16 w3-round w3-input w3-border w3-content"><br/><br/>
                                    
                                    CURRENT ADDRESS:<textarea name="txaaddr" style="border:none;border-bottom:2px solid orange;background-color:inherit;color:white;" rows="2" cols="20" placeholder="Enter current address" class="w3-padding-16 w3-input w3-border w3-round w3-content"></textarea><br/>
								    
                                   PERMANENT ADDRESS:  <textarea name="txaaddr" style="border:none;border-bottom:2px solid orange;background-color:inherit;color:white;" rows="2" cols="20" placeholder="Enter permanent address" class="w3-padding-16 w3-input w3-border w3-content w3-round"></textarea><br/></br>
                                    
                                    BANK ACCOUNT NUMBER:<input type="text" style="border:none;border-bottom:2px solid orange;background-color:inherit;color:white;" name="txnmobile" placeholder="Enter bank Account number" required="" class="w3-padding-16 w3-input w3-border w3-content w3-round"><br/>
                                    
                                    AADHAR NUMBER:<input type="number" style="border:none;border-bottom:2px solid orange;background-color:inherit;color:white;" name="txnmobile" placeholder="Enter aadhar number" required="" class="w3-padding-16 w3-input w3-border w3-content w3-round"><br/>
                                    ...
                                    BHAMASHAH NUMBER:<input type="number" style="border:none;border-bottom:2px solid orange;background-color:inherit;color:white;" name="txnmobile" placeholder="Enter PAN number" required="" class="w3-padding-16 w3-input w3-border w3-content w3-round"><br/>
                                    ...
                                    DO YOU HAVE A COMPUTER?<br/><input type="radio" name="computer" value="yes" class="w3-btn" onclick="myFunY();">YES <input type="radio" name="computer" value="no" class="w3-btn" onclick="myFunN();">NO
                                    <br/>
                                    <script>
                                        function myFunY() {
                            ...
                            <div id="myDiv">
                              ...
                              <br/></div>
                                    ...
                                    <input type="button" value="YES" onclick="myFunction();" id="YN">
                                    <script>
                                        function myFunction() {
                                            var x = document.getElementById("myDIV");
                                   ...
                                   <div class="slidecontainer" id="myDIV" style="display: none">
                                    ...
                                    <input type="range" min="0" max="100" value="40" class="slider" id="loan">
                                ...
                                <input type="submit" class="w3-button w3-margin-bottom w3-content w3-border w3-round w3-ripple w3-hover-green" value="NEXT" />
